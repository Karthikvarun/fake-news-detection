library(keras)
install_keras()
train <- read.csv(file="D:/New Dataset/Binary_training.csv",header = T)
test <- read.csv(file="D:/New Dataset/Binary_testing.csv",header = T)
