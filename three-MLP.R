library(keras)
install_keras()
train <- read.csv(file="D:/New Dataset/three_training.csv",header = T,stringsAsFactors=TRUE)
test <- read.csv(file="D:/New Dataset/three_testing.csv",header = T,stringsAsFactors=TRUE)
