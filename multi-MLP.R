library(keras)
install_keras()
train <- read.csv(file="D:/New Dataset/multi_training.csv",header = T,stringsAsFactors=TRUE)
test <- read.csv(file="D:/New Dataset/Multi_testing.csv",header = T,stringsAsFactors=TRUE)
